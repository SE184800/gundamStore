        ...
        <div className="fixed bottom-24 right-5 z-50 w-[320px] overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl">
          <div className="flex items-center justify-between bg-blue-700 px-4 py-3 text-white">
            <div>
              ...
              <div className="text-xs font-semibold text-white/80">{t("chat.subtitle")}</div>
            </div>
      ...
      <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end gap-2">
        ...
        >
          ...
          <span className="grid max-w-0 overflow-hidden text-left transition-all duration-300 group-hover:ml-3 group-hover:max-w-[210px]">
            ...
            <span className="whitespace-nowrap text-[11px] font-semibold text-white/80">{t("chat.openDemo")}</span>
          </span>
        </button>
        ...
        >
          ...
          <span className="grid max-w-0 overflow-hidden text-left transition-all duration-300 group-hover:ml-3 group-hover:max-w-[210px]">
            <span className="whitespace-nowrap text-sm font-black">{t("chat.staff")}</span>
            <span className="whitespace-nowrap text-[11px] font-semibold text-white/80">{t("chat.staffDesc")}</span>
          </span>
        </a>
