  ...
  return (
    <PageShell>
      <main className="mx-auto max-w-[1100px] px-4 py-8 lg:px-8">
        <section className="rounded-[36px] bg-gradient-to-br from-blue-700 to-cyan-500 p-8 text-white">
        ...
        <section className="mt-8 grid gap-5 md:grid-cols-2">
          {[
            ...
            <article key={title} className="rounded-[26px] border border-slate-200 bg-white p-6 shadow-sm">
