  ...
  return (
    <PageShell>
      <main className="mx-auto max-w-[1440px] px-4 py-8 lg:px-8">
        <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
          <div className="grid gap-6 lg:grid-cols-[1fr_420px]">
            <div>
              <div className="text-xs font-black tracking-wide text-blue-700">Builder Accessories</div>
            ...
            <div className="rounded-xl bg-gradient-to-br from-blue-600 to-cyan-400 p-6 text-white">
              <div className="text-xs font-black tracking-wide text-white/80">Builder Kit</div>
